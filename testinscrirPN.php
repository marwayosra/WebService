...
<center><h3>Ajouter un nouveau pharmacie de nuit</h3></center>
...
try
{
$sql = mysql_query("INSERT INTO pharmacieNuit (name,address,tel,ville,seancecontinu,lat,lng) VALUES ('".$name."','".$address."','".$tel."','".$ville."','".$seancecontinu."','".$lat."','".$lng."')");
if (!$sql) 
